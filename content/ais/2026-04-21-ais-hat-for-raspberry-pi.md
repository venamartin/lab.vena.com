...
1. Open the Signal K dashboard in your browser:
...
5. Check the Data Browser to confirm AIS messages are being received.

6. (Optional) Install plugins for data forwarding such as MarineTraffic or OpenAIS.
